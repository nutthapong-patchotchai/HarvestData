...
urlpatterns = [
    ...
    path('farmer/<int:id>/create/', farmer_views.CreateFarmer, name='createFarmer'),
    path('farmer/<int:id>/edit', farmer_views.EditFarmer, name='editFarmer'),
    path('farmer/<int:id>/delete', farmer_views.DeleteFarmer, name='deleteFarmer'),
